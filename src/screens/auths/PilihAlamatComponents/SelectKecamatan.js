...
import {getKabupatenKota, getKecamatan} from '../../../states/auth/authAction';
import {
  ActivityIndicator,
  StyleSheet,
  FlatList,
...
const SelectKecamatan = props => {
  ...
  return (
    <DefaultBottomSheet title="Kecamatan" onClose={() => props.onClose()}>
